...
from tests.POM_OPTIMIZATIONS.AccountPage import AccountPage
...
class LoginPage:
    ...
    def login_to_application(self,email_address,user_pwd):
        self.enter_into_email_address(email_address)
        self.enter_into_password(user_pwd)
        return self.click_at_Login_button()
